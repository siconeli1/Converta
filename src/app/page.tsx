        ...
        <section className="hero">
          <div className="hero-copy">
            ...
            <div className="hero-note">
              ...
              <span><Clock3 size={15} /> Exclusão em 7 dias</span>
            </div>
          </div>
        ...
        <section className="band band-alt">
          <div className="shell">
            ...
            <div className="benefits">
              ...
              <div className="benefit"><span className="benefit-icon"><LockKeyhole size={20} /></span><div><h3>Privacidade clara</h3><p>Links temporários, exclusão manual e retenção planejada de sete dias.</p></div></div>
            </div>
          </div>
        </section>
      </main>
